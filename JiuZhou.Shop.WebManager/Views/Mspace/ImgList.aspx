...
<form action="/Mspace/imgList" method="get">
...
<div class="console" style="position:relative;margin:0 auto;text-align:left;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="javascript:;" onclick="changeImg()">替换图片</a>
	<a href="/mspace/uploadImage" target="_blank" style="position:absolute;right:10px;top:5px;"><b class="add">&nbsp;</b>批量上传图片</a>
</div>
...
<div class="list-img-box">
	...
	<div class="imsg">
<p>原文件名：<br /><%=item.file_name%></p>
<p>保存文件名：<br /><%=item.save_path %></p>
<p>分类：<%
        string[] _tem = null;
...
<div class="clear">&nbsp;</div>
<%Html.RenderPartial("ChangeImageControl"); %>
