...
<body>
    ...
    <div id="container-syscp">
        ...
        <div class="container-right">
            ...
            <div class="div-tab">
                <form id="SeoClassRuleForm" method="post" action="" onsubmit="return submitSeoClassRuleForm(this)">
                                ...
                                <script language="c#" runat="server">
                                    ...
                                    public void PrintList(int parentId, int ruleid,List<SeoRuleItemInfo> rils)
                                    {
                                        ...
                                        if (rils != null)
                                        {
                                            ...
                                            {
                                                srs =
                                            rils.Where(t => t.elment_id == 3).ToList();
                                            }
                ...
                <table class="table" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="lable">
                                <input type="button" id="loadding3" value="  确定提交  " onclick="$('#SeoClassRuleForm').submit()"
    ...
    <script type="text/javascript">
        ...
        function submitSeoClassRuleForm(form) {
            var isError = false;
            ...
            if ($(".selecedtype ul li").length == 0) {
                jsbox.error("请在类别中至少选择一个"); return false;
            }
            ...
            $(".selecedtype ul li").each(function () {
                ...
                var node = '<item rule_item_id="' + rule_item_id + '" elment_id="3"  seo_elment_code="' + typeid + '"></item>';
                nodes.push(node);
            });
            var xml = createXmlDocument(nodes);
            $.ajax({
                url: "/MGoods/PostSeoClassRule"
