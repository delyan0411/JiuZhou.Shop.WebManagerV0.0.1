...
%>
  <tr>
    <td><input type="checkbox" onclick="selectOne(this)" name="visitid" value="<%=item.help_id%>" /></td>
...
%></p>
    ...
    <td><input type="text" class="input" style="width:30px;text-align:center;" onblur="resetSort('<%=item.help_id%>', this.value)" onclick="this.select()" value="<%=item.sort_no%>"/></td>
