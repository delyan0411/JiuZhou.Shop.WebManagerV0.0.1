...
&nbsp;&nbsp;
<a href="javascript:;" onclick="resetStatusList()" class="black">放入回收站</a>
...
<%
    ...
    foreach (SysFiles item in infoList)
    {
        ...
        string ext = item.save_name.Substring(item.save_name.LastIndexOf(".") + 1);
        string imgPath = "/images/document/doc.png";
        switch (ext)
        {
            case "pdf":
                imgPath = "/images/document/pdf.png";
                break;
            case "rmvb":
            case "wav":
            case "mpeg":
            ...
            case "mkv":
            case "swf":
                imgPath = "/images/document/avi.png";
                break;
            case "mp3":
                imgPath = "/images/document/music.png";
                break;
            case "rar":
            case "zip":
            case "apk":
            ...
            case "deb":
            case "pxl":
                imgPath = "/images/document/rar.png";
                break;
        }
%>
...
<div class="list-img-box">
	...
	<a href="<%=item.save_path%>" target="_blank" class="iLink">
		<i style="background:url("<%=imgPath%>") center center no-repeat;">&nbsp;</i>
    </a>
