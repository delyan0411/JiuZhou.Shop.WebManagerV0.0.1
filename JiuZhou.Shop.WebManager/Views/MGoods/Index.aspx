        ...
        <div class="container-right">
            ...
            <form action="/mgoods" method="get" onsubmit="checksearch(this)">
                ...
                <div class="div-tab-h1" style="font-weight: 100; color: #333; font-size: 12px">
                    <p>
                        <select id="stype" name="stype" style="width: 80px; height: 26px;">
                ...
                <table id="tab-category" class="table" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 9%">&nbsp;&nbsp;<a href="javascript:;" onclick="changeOrderBy('stocknum','<%=otype=="asc"?"desc":"asc"%>')">库存</a><br />
                                &nbsp;虚拟库存</th>
            ...
            <div class="atai-shade-contents">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="old-pname" class="input" value="" style="width: 380px; height: 25px; line-height: 25px;" disabled="disabled" /></td>
                    </tr>
