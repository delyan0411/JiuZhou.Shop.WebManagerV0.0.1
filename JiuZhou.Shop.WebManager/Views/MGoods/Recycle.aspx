...
<body>
    ...
    <div id="container-syscp">
        ...
        <div class="container-right">
            <div class="position">
                当前位置：
                <a href="/" title="管理首页">管理首页</a> &gt;&gt; <span>商品回收站</span>
            </div>
            <form action="/mgoods/recycle" method="get" onsubmit="checksearch(this)">
                ...
                <div class="div-tab-h1" style="font-weight: 100; color: #333; font-size: 12px">
                    ...
                    <p>
                        <select id="classid" name="classid" style="width: 80px; height: 26px;">
                    ...
                    <p>
                        <select id="shopid" name="shopid" style="width: 160px; height: 26px;">
                    ...
                    <p>
                        <input type="text" id="sQuery" name="q" value="<%=DoRequest.GetQueryString("q")%>" class="input" autocomplete="off" onkeyup="suggest.init(event,this,'/MTools/SeachSuggest')" style="width: 390px; height: 24px; line-height: 24px;" />
                    </p>
                    <p>
                        <input type="submit" value=" 搜索 " class="submit" />
                    </p>
                    <p>
                        <a href="/mgoods/export?classid=<%=classid %>&sType=<%=sType %>&shopid=<%=DoRequest.GetQueryInt("shopid", -1)%>&promotion=-1&ison=0&isVisible=-1&insurance=-1" style="font-size: 20px" target="_blank">导出商品</a>
                    </p>
                </div>
            </form>
            ...
            <form id="post-form" method="post" action="">
                ...
                <table id="tab-category" class="table" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" onclick="selectOne(this)" name="visitid" value="<%=info.product_id%>" /></td>
                            ...
                            <td>
                                ...
                                <p style="color: #999">
                                    商品分类：<%  string _s = info.product_type_path;
                         ...
                         for (int x = 0; x < _tem.Length; x++)
                         {
                            ...
                            <td><%=info.is_visible==1?"<span>在售</span>":"<span style='color:#999'>回收站</span>"%></td>
                            <td></td>
                        </tr>
                        <%}
                        %>
                ...
                <div class="console">
                    <a href="javascript:;" onclick="deleteList(Atai.$('#post-form'), 1)" class="read">还原商品</a>
                </div>
            </form>
            <br />
            <br />
